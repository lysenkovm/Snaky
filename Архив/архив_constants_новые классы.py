...
#             self.name = DIRS_POINTS_TO_NAMES[self.points]
#         elif isinstance(direction, str):
#             self.name = direction
#             self.points = DIRS_NAMES_TO_POINTS[self.name]
#         self.axis = DIRS_NAMES_AXES[self.name]
    
#     def calc_opposite(self, attribute):
#         return 
